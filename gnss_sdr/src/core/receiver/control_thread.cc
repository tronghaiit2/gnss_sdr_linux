...
{
    //haint
    char* file = (char*) malloc(sizeof(char) * receiveData.BUFSIZE);
    snprintf(file, receiveData.BUFSIZE, "/tmp/controlling.txt");
    receiveData.init(file);
    free(file);
    //haint
