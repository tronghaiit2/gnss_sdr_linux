...
std::string sv_list = configuration_->property("GPS.prns", std::string(""));
    ...
    std::string sv_banned = configuration_->property("GNSS-SDR.GPS_banned_prns", std::string(""));
    if (!sv_banned.empty())
        {
    ...
    // sv_list = configuration_->property("Galileo.prns", std::string(""));
    ...
    // sv_banned = configuration_->property("GNSS-SDR.Galileo_banned_prns", std::string(""));
    // if (!sv_banned.empty())
    //     {
    //         std::stringstream ss(sv_banned);
    //         while (ss.good())
